# **B**io**F**ormats **I**nput/**O**utput utility (bfio 2.2.1-dev0)
...
### labshare/polus-bfio-util:2.2.1-dev0

Ubuntu based container with bfio and all dependencies (including Java).

### labshare/polus-bfio-util:2.2.1-dev0-imagej

Same as above, except comes with ImageJ and PyImageJ.

### labshare/polus-bfio-util:2.2.1-dev0-tensorflow
