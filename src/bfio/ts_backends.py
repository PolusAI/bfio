...
class TensorstoreWriter(bfio.base_classes.TSAbstractWriter):
        ...
        def _init_writer(self):
            ...
            self._writer = TSWriter(str(self.frontend._file_path.resolve()), shape, (1, 1, 1, self.frontend._TILE_SIZE, self.frontend._TILE_SIZE), self.frontend.dtype, "TCZYX")
        ...
        def write_image(self, X, Y, Z, C, T, image):
            ...
            self._writer.write_image_data(image.flatten(), rows, cols, layers, channels, tsteps)
